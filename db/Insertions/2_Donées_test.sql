...
INSERT INTO myApp_correspondre (documentTechnique_id, modeleEquipement_id) VALUES
((SELECT id FROM myApp_documenttechnique WHERE nomDocumentTechnique = 'Manuel d''utilisation PM-1000'), 1),
((SELECT id FROM myApp_documenttechnique WHERE nomDocumentTechnique = 'Guide de maintenance PM-1000'), 1);
...
('Rapport calibration projecteur EQ-001', 'documents/documentDefaillance/rapport_calibration_projecteur_EQ-001.pdf', 
 (SELECT id FROM myApp_defaillance WHERE commentaireDefaillance = 'Problème de calibration du projecteur' AND equipement_id = 'EQ-001')),
...
('Rapport défaillance scanner EQ-005', 'documents/documentDefaillance/rapport_defaillance_scanner_EQ-005.pdf', 
 (SELECT id FROM myApp_defaillance WHERE commentaireDefaillance = 'Défaillance du scanner de documents' AND equipement_id = 'EQ-005')),
