<template>
  ...
  export default {
    ...
    setup() {
      ...
      // Navigation vers la page d'ajout de lieu
      const goToAddLieuPage = () => {
        router.push('/ajouterLieu'); // Remplacez '/ajouter-lieu' par l'URL de la page que vous voulez rediriger
      };
      ...
      return {
        ...
        onSelectLieu,
        toggleNode,
        goToAddLieuPage, // Ajoutez la fonction ici
      };
    }
  };
  </script>
