        ...
        try {
          ...
          for (const doc of documents.value) {
            if (doc.nom && doc.fichier) {
              ...
              formData.append('nomDocumentDefaillance', doc.nom);
              formData.append('lienDocumentDefaillance', doc.fichier);
              formData.append('defaillance', defaillanceId);
          ...
          if (allSuccess) {
            ...
            router.push({ name: 'AfficherDefaillance', params: { id: defaillanceId } });
          } else {
