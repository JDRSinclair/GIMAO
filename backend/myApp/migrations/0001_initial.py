# Generated by Django 3.2 on 2024-12-20 09:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('createurIntervention', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='createurIntervention', to=settings.AUTH_USER_MODEL)),
                ('defaillance', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='myApp.defaillance')),
                ('responsable', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='responsable', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('prixAchat', models.DecimalField(blank=True, decimal_places=2, help_text="Prix au qu'elle vous avont aquit le lot", max_digits=10, null=True)),
